  ...
  <body class="container">
    ...
    <div class="row">
        <div class="col">
            ...
            <input type="number" id="dia" name="dia" class="from-control">
        </div>
        <div class="col">
            <label for="mes" class="label-control">Mês: </label>
            <input type="number" id="mes" name="mes" class="from-control">
        </div>
        <div class="col">
            <label for="ano" class="label-control">Ano: </label>
            <input type="number" id="ano" name="ano" class="from-control">
        </div>
    </div>
    <div class="row">
        <div class="col">
